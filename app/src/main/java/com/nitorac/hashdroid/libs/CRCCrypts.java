...
public class CRCCrypts {
        ...
        static int [] CRC32Tab = {0x00000000,0x77073096,0xEE0E612C,0x990951BA,0x076DC419,0x706AF48F,0xE963A535,0x9E6495A3,
    ...
    public static int CRC32Add (int crc, int c)
    {
    ...
    public static int StrCRC32(String str)
    {
        int len=str.length();
        int crc;
...
*/
    ...
    public static String Hex32(int val)
    {
        int n;
        String str1;
        String str2;
        ...
        n=val&0xFFFF;
        str1=Integer.toHexString(n).toUpperCase();
        while (str1.length() < 4)
        {
            str1="0"+str1;
        }
        ...
        n=(val>>>16)&0xFFFF;
        str2=Integer.toHexString(n).toUpperCase();
        while (str2.length() < 4)
        {
            str2="0"+str2;
        }
    ...
    public static String cryptCRC32(String text)
    {
        return Hex32(StrCRC32(text));
    }
